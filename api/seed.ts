...
const seed = async (): Promise<void> => {
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/1119/5850/products/hot-pink-grid_b0f646f8-97ff-4989-bffc-c26a1c4a2d2a_1024x1024.jpg?v=1595855762',
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://fanatics.frgimages.com/FFImage/thumb.aspx?i=/productimages/_3802000/ff_3802240-4b85edcce601a42d6641_full.jpg'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/1119/5850/products/white-grid_a6907af6-5150-4ff6-a55c-26211e872e86_1024x1024.jpg?v=1591036263' +
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://www.vivobarefoot.com/userdata/root/images/products/mens/primus-trail-fg/w_200174-01_side.jpg'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://www.burtsbees.com/dw/image/v2/AAPA_PRD/on/demandware.static/-/Sites-burtsbees-master-catalog/default/dw80d6ce90/images/large/792850910638.jpg?sw=380&sh=380&sm=fit'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://www.burtsbees.com/dw/image/v2/AAPA_PRD/on/demandware.static/-/Sites-burtsbees-master-catalog/default/dwa8267b1b/images/large/792850902398.jpg?sw=380&sh=380&sm=fit'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://images.prismic.io/molekule/4720c1c9-23fa-4ffe-8171-f2cd988ebac0_SEO+-+Air.png?auto=compress,format&max-w=1200&max-h=1200&fit=crop'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/2665/7478/products/PDP-OJ_wedding_0306203317_R2_TopCoat2-newyellow_1200x1200.jpg?v=1589409163'] },
  ...
  await prisma.product.create({
    data: {
      title: 'Grateful & Kind',
      images: { set: ['http://cdn.shopify.com/s/files/1/2665/7478/products/Pink-OJ_VidStills_061119_5863_R1_1200x1200.jpg?v=1589181156' +
  ...
  await prisma.product.create({
    data: {
      title: '',
      images: { set: ['http://cdn.shopify.com/s/files/1/1491/5166/products/CTH-BLK_grande.jpg?v=1573607160' +
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/1491/5166/products/CrewSockPack_x3_76539edc-3c35-42e6-9eba-25acb643e4bc_grande.jpg?v=1594243084',
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/0026/5302/8425/products/w-s-black_1200x1200.jpg?v=1574244588',
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/0026/5302/8425/products/l_white_1200x1200.jpg?v=1574235378',
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://images.prismic.io/dirtylemon-2018/96df3a862697e8f3db764345ff3b650b36849c8d_img_0287.jpg?auto=compress,format'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://images.prismic.io/dirtylemon-2018/d11612abcca746f4af27577bc28ae34c9208877c_photo-aug-28-1-41-30-pm.jpg?auto=compress,format'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['//cdn.shopify.com/s/files/1/0209/8446/products/Happi_Scalp_Scrub_Standard_01_1024px_72dpi_NEW_medium.jpg?v=1585186810'] },
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/2403/5811/products/rose-gold-3-tiny_grande.png?v=1575515327',
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/0252/5593/6086/products/ScreenShot2020-03-20at7.18.09PM_1200x1200.png?v=1584753837',
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['http://cdn.shopify.com/s/files/1/0252/5593/6086/products/Ican_tfeelmyfacesingle_1200x1200.png?v=1584755353',
  ...
  await prisma.product.create({
    data: {
      ...
      images: { set: ['https://media-live.byredo.com/media/catalog/product/optimized/8/5/8529df057ba542031c76db2227539212ccfb359560579b72c48c9f95905e385f/mob_la-selection-nomade-3x12-ml_1_1.jpg'] },
